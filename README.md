...
Super keyword is used to call the constructor of its parent class to access the parent’s properties and methods. Whenever we are using a constructor inside a derived class, then we must declare/initialize or call the parent class constructor using the keyword parent() inside the constructor. 
